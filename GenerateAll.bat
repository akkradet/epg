...
cd %USERPROFILE%\AppData\Local\WebGrab+Plus
del %USERPROFILE%\AppData\Local\WebGrab+Plus\WebGrab++.config.xml /Q
xcopy /S /I /Q /Y /F "D:\Git\epg_encrypted\trueid.config.xml" "%USERPROFILE%\AppData\Local\WebGrab+Plus\"
"C:\Program Files (x86)\WebGrab+Plus\bin\WebGrab+Plus.exe"
...
cd %USERPROFILE%\AppData\Local\WebGrab+Plus
del %USERPROFILE%\AppData\Local\WebGrab+Plus\WebGrab++.config.xml /Q
xcopy /S /I /Q /Y /F "D:\Git\epg_encrypted\gigatv.config.xml" "%USERPROFILE%\AppData\Local\WebGrab+Plus\"
"C:\Program Files (x86)\WebGrab+Plus\bin\WebGrab+Plus.exe"
