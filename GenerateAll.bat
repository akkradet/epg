...
xcopy /S /I /Q /Y /F "D:\Git\epg_encrypted\aisplay\WebGrab++.config.xml" "%USERPROFILE%\AppData\Local\WebGrab+Plus\"
...
cd %USERPROFILE%\AppData\Local\WebGrab+Plus
del %USERPROFILE%\AppData\Local\WebGrab+Plus\WebGrab++.config.xml /Q
xcopy /S /I /Q /Y /F "D:\Git\epg_encrypted\trueid\WebGrab++.config.xml" "%USERPROFILE%\AppData\Local\WebGrab+Plus\"
"C:\Program Files (x86)\WebGrab+Plus\bin\WebGrab+Plus.exe"
...
cd %USERPROFILE%\AppData\Local\WebGrab+Plus
del %USERPROFILE%\AppData\Local\WebGrab+Plus\WebGrab++.config.xml /Q
xcopy /S /I /Q /Y /F "D:\Git\epg_encrypted\gigatv\WebGrab++.config.xml" "%USERPROFILE%\AppData\Local\WebGrab+Plus\"
"C:\Program Files (x86)\WebGrab+Plus\bin\WebGrab+Plus.exe"
...
cd %USERPROFILE%\AppData\Local\WebGrab+Plus
del %USERPROFILE%\AppData\Local\WebGrab+Plus\WebGrab++.config.xml /Q
xcopy /S /I /Q /Y /F "D:\Git\epg_encrypted\tvsmagazine\WebGrab++.config.xml" "%USERPROFILE%\AppData\Local\WebGrab+Plus\"
"C:\Program Files (x86)\WebGrab+Plus\bin\WebGrab+Plus.exe"
xcopy /S /I /Q /Y /F "%USERPROFILE%\AppData\Local\WebGrab+Plus\tvsmagazine.com.epg.xml" .
tar zcvf tvsmagazine.com.epg.xml.gz tvsmagazine.com.epg.xml
echo Generated successfully. >> GeneratedDate
echo Website: tvsmagazine.com >> GeneratedDate
echo Name: tvsmagazine.com >> GeneratedDate
git add .
git commit -m "Generated at %date:~4,11% %date:~0,3% %time:~0,2%:%time:~3,2%:%time:~6,2% ICT"
git push